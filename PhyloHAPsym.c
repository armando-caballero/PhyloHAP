...
/* PhyloHAPsym.c (Littorina sympatric model; n haploid subpopulations RB and SU;
...
main()
{
	...
	{
		// FULL MIGRATION BETWEEN HIGH AND LOW AND NO SELECTION
...
migrationSYM()
{
	...
	// 50% of individuals migrate between high and low
	migs = nind/2;
